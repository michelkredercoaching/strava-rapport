...
// Tweede, losstaand signaal voor de mails: aerobe decoupling. Gebruikt in de
// koper-journey als extra herkenningsregel bovenop de hoofddiagnose (PIJN), of
// juist als sterk-punt-compliment als de basis goed is. Zelfde drempel als de
// PDF (<=5% sterk, >5% zwak), zie de AEROBE DECOUPLING-kaart verderop in dit
// bestand. Geeft niks terug (BIJPIJN blijft leeg) zonder betrouwbare meting,
// bijvoorbeeld als er geen rit lang genoeg was.
function bepaalDecouplingSignaal(m) {
