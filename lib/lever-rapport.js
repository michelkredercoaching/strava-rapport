...
async function bouwRapportPdf(meta) {
  ...
  if (ftp && wGew) {
    ...
    const curveUitlegLines = curveOntbreekt.length
      ? wrapTxt(`Leeg = geen volle inspanning van ${curveOntbreekt.join(' of ')} in je laatste 90 dagen. Daardoor rust je FTP-schatting alleen op je kortere pieken.`, reg, 8, R-M-32)
      : [];
