...
async function bouwRapportPdf(meta) {
  ...
  const blokken=[];
  if (meerVolume){
    blokken.push({type:'DUURKRACHT — TEMPOBLOK · 1X PER WEEK', oms:`5x8 min op ${wB(0.70,0.75)} · 4 min rust tussen sets`, det:'Bouwt je aerobe motor zonder je leeg te trekken. Comfortabel zwaar — je kunt nog korte zinnen praten. Rijd het op een laag toerental (60–70) en het werkt ook als krachtblok. Één keer per week is genoeg.'});
    ...
    blokken.push({type:'DUURKRACHT — TEMPOBLOK · 1X PER WEEK', oms:`5x5 min op ${wB(0.70,0.75)} · 3 min rust tussen sets`, det:'De efficiënte manier om je aerobe basis te bouwen als je weinig tijd hebt. Comfortabel zwaar, niet vol. Rijd het op een laag toerental (60–70) en het werkt ook als krachtblok. Één keer per week — vaker is niet nodig.'});
