...
async function bouwRapportPdf(meta) {
  ...
  // ===== PAGINA 2: AEROBE DECOUPLING (+ TREND) — altijd op een eigen pagina =====
  nieuwePagina();
  ...
  // ===== PAGINA 3: WATT/KG + POWER CURVE — altijd op een eigen pagina =====
  nieuwePagina();
  ...
  // ===== PAGINA 4: AANDACHTSPUNT + ACTIEPLAN + INTERVALBLOKKEN + WEEK =====
  nieuwePagina();
