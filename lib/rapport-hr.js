...
export async function bouwRapportPdfHr(meta) {
  ...
  const acties=[
    ...
    bRustig?`Rijd je rustige ritten op ${bRustig} (D1). Boven ${bGrijs} zit je in het grijze gebied: te zwaar om van te herstellen, te licht om van te groeien.`:'Rijd je rustige ritten écht rustig, je kunt volledige zinnen praten. Blijf uit het grijze gebied.',
    op?`Voeg 1x per week een blok boven je omslagpunt toe: korte intervallen op RPE 9/10 (Weerstand, > ${op} bpm), bijvoorbeeld 30 sec aan en 30 sec uit.`:'Voeg 1x per week een intervalblok toe: korte intervallen op RPE 9/10, bijvoorbeeld 30 sec aan en 30 sec uit.'
  ];
  ...
  txt('Kies één VO2max-variant en houd die 4 tot 6 weken vol. Daarna pas wisselen.',M,y,{font:reg,size:8,color:DIM}); y-=13;
  blokken.forEach(b=>{
