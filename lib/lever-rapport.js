...
import { bepaalPijn, bepaalDecouplingSignaal } from './pijn-signalen.js';
...
// Rennerstype uit de curve-vorm: hoe pieky (1min t.o.v. FTP) + klimvermogen
// (W/kg). Puur afgeleid uit data die er al is, geen nieuwe metingen nodig.
// Gedeeld tussen de PDF (actieplan) en de klantmail (teaser), zodat de mail
// dezelfde "sterk op 5 min, zwak op 20 min"-hook uit de reels kan gebruiken
// i.p.v. alleen decoupling/grijze-gebied (Michel, 21-09-2026).
function bepaalRennerstype(ftp, piek1, wGew) {
...
// 5 min t.o.v. 20 min: het directe "sterk op 5, zwak op 20"-paar uit de reels
// (of andersom bij een diesel-motor). Los van rennerstype (dat gaat over 1 min
// t.o.v. FTP) — dit is een onafhankelijk, tweede signaal. FTP zelf blijft
// buiten beeld, want FTP is deels AFGELEID van de 20-min piek (FTP-formule),
// dus die twee tegen elkaar afzetten zou circulair zijn.
function bepaalCurveBadges(piek5, piek20) {
  const badges = {};
  if (piek5 && piek20) {
