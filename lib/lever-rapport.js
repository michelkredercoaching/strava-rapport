...
async function bouwRapportPdf(meta) {
  ...
  // Bij 'hoog' staat de FTP als een huis → geen test nodig. Zodra 'ie lager is
  // (gemiddeld/schatting) is het getal een ondergrens; dan stuurt de pill juist
  // aan op een gerichte 20-min test i.p.v. de klant valse zekerheid te geven.
  const pillTekst = betr==='hoog' ? 'GEEN FTP-TEST NODIG' : 'DOE EEN 20-MIN TEST';
