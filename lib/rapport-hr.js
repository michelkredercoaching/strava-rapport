...
export async function bouwRapportPdfHr(meta) {
  ...
  if (decouplingHr !== null && !Number.isNaN(decouplingHr)) {
    ...
    const nietGemetenUitleg = 'We vonden geen kwalificerende vlakke, rustige duurrit in je laatste 90 dagen om dit op te berekenen. Rijd zo’n rit en we kunnen dit bij je volgende analyse wel meten.';
