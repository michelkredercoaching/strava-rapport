  ...
  if (meta.vorige && meta.vorige.ftp && ftp) {
    ...
    if (vorigeFtp) {
      ...
      const vervolgTekst = 'Rijd de komende 90 dagen door en doe dan opnieuw een analyse om je vooruitgang te checken.'
        + ((ftp && !ftpIsHoog) ? ` Je FTP staat nu nog op een ondergrens: doe binnen nu en een maand ook een volle inspanning (bijvoorbeeld een 20-minutentest) om 'm definitief vast te leggen.` : '');
