...
//
// LET OP, hier ging het 16-09-2026 mis: er stond `tracking_code: m.bron` in de
// order. Dat veld is bij Mailchimp geen vrij tekstveld maar een enum met exact
// één toegestane waarde ('prec', hun eigen mc_tc-retargetingcode). Elke andere
// string, óók een lege, geeft 400 "Data presented is not one of the accepted
// values" en dan wordt de order helemaal niet aangemaakt. Omdat deze functie
// fail-safe is aangeroepen (fout wordt alleen gelogd) verdween de omzetmeting
// stilletjes: laatste order 16-09 12:33, daarna vijftien kopers zonder order.
// Bron-attributie hoort hier dus niet thuis; wil je dat alsnog, gebruik dan
// `landing_site` (vrije URL) of `campaign_id` (een echt Mailchimp-campagne-id).
//
